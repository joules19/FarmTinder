<template>
    <Popover class="relative bg-white z-[1000] md:w-[1440px]">
        <div class="mx-auto max-w-[81rem]">
            <div class="flex items-center justify-between h-[74px] md:justify-start md:space-x-10">
                                        ...
                                        <div>
                                            ...
                                            <ul role="list" class="mt-4 space-y-4">
                                                <li v-for="post in recentPosts" :key="post.id" class="truncate text-base">
                                                    <a :href="post.href"
                                                        class="font-medium text-gray-900 hover:text-gray-700">{{ post.name
                                                        }}</a>
                                                </li>
                                            </ul>
                                        </div>
                ...
                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0 space-x-3">
                    <div
                        class="bg-[#F2F5F5] text-gray-400 flex items-center w-[38px] h-[30px] justify-center rounded-lg p-1">
                        <img :src="HeartIcon" />
                    ...
                    <div class="flex items-center w-[30px] h-[30px] justify-center rounded-xl">
                        <img :src="UserIcon" />
